...
TweenLite.set(".bottom_1", { x: 2 * _commonJsCommonJs.size.w });
TweenLite.set(".bottom_2", { x: _commonJsCommonJs.size.w });

TweenLite.set(".top_1", { x: -_commonJsCommonJs.size.w * 2 });
TweenLite.set(".top_2", { x: -_commonJsCommonJs.size.w });
...
tl.add("bring_end", "+=.3");
tl.to(".bring", { duration: .1, x: -_commonJsCommonJs.size.w / 2, y: -_commonJsCommonJs.size.h / 2, scale: .5 }, "bring_end");
