...
tl.add("dash", 0);
TweenLite.to(".dash.top", { duration: 14, x: "+=" + _commonJsCommonJs.size.w * 2, ease: "power1.out" }, "dash");
TweenLite.to(".dash.bottom", { duration: 14, x: "-=" + _commonJsCommonJs.size.w * 2, ease: "power1.out" }, "dash");
...
tl.from(".zero_middle", { duration: .3, y: "-=" + _commonJsCommonJs.size.h }, "+=.2");
...
tl.to(".bring", { duration: .3, x: -_commonJsCommonJs.size.w / 2, y: -_commonJsCommonJs.size.h / 2, scale: .5 }, "+=.3");
